 ...
 * <ul>
 *   <li>Top-level main loop and navigation across submenus</li>
 *   <li>CRUD operations for short links via {@link ShortLinkService}</li>
 *   <li>User management actions via {@link UserService}</li>
 *   <li>Event viewing via {@link EventService}</li>
 *   <li>Runtime configuration inspection/reload via {@link ConfigJson}</li>
 * </ul>
 *
 * <h2>I/O model</h2>
 * <ul>
 *   <li>Reads trimmed lines using {@link InputUtils#readTrimmed(String)}.</li>
 *   <li>Gracefully exits the loop on EOF, or if the user chooses an exit command.</li>
 * </ul>
 *
 * <h2>Thread-safety</h2>
 * <p>The class is intended for single-threaded, interactive console use.</p>
 *
 * <h2>Error handling</h2>
 * <ul>
 *   <li>Validation messages are printed to the console.</li>
 *   <li>Operations that can fail return early and inform the user without throwing UI-level exceptions.</li>
 * </ul>
 */
public class ConsoleMenu {
     ...
     * <p>Reads a single-line command, routes to the appropriate submenu/action, and repeats.</p>
     */
     ...
     * <p>Loops until the user returns to the previous menu.</p>
     */
     ...
     * <p>Validates number input, delegates creation to {@link ShortLinkService#createShortLink(String, Integer)},
     * and prints the resulting link summary or validation error.</p>
     */
     ...
     * <p>Supports:
     * <ul>
     *   <li>Status filter (ALL/ACTIVE/EXPIRED/LIMIT_REACHED/DELETED)</li>
     *   <li>Text search across shortCode and URL</li>
     *   <li>Sort by created desc / clicks desc / expires asc</li>
     * </ul>
     * Prints a fixed-width table or a message if nothing matches.</p>
     */
    ...
    /**
     * Prints detailed information about a single link, looked up by short code (or full baseUrl+code).
     */
     ...
     * <p>Accepts a number ≥ current clicks or the keyword {@code unlimited}.</p>
     */
     ...
     * <p>Allows entering a short code (or {@code baseUrl+code}) to open in the default browser.</p>
     */
    ...
    /**
     * Handles maintenance utilities: cleanup expired/limit-reached, validate JSON, show stats, view global events.
     */
     ...
     * <p>Also updates event logging enablement and passes the new config to {@link ShortLinkService}.</p>
     */
     ...
     * <p>Updates {@link UserService} and {@link ShortLinkService} ownership context.</p>
     */
     ...
     * <p>Delegates to {@link ShortLinkService#statsMine(int)} or {@link ShortLinkService#statsGlobal(int)}.</p>
     */
     ...
     * <ul>
     *   <li>Delete/mark expired</li>
     *   <li>Delete/mark limit-reached</li>
     *   <li>Export current user's links</li>
     * </ul>
     */
     ...
     * <p>If issues exceed 30, prints only the first 30 lines and a tail count.</p>
     */
