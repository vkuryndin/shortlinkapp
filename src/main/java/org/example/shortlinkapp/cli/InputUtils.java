 ...
 *
 * <p>This utility wraps a single {@link Scanner} over {@code System.in} (UTF-8) and provides
 * a single convenience method {@link #readTrimmed(String)} that:
 *
 * <ul>
 *   <li>Prints a prompt (without a newline),</li>
 *   <li>Reads a line from standard input,</li>
 *   <li>Trims leading/trailing whitespace,</li>
 *   <li>Returns {@code null} when the input stream is closed, the scanner is closed, or a
 *       {@link NoSuchElementException} occurs (EOF).</li>
 * </ul>
 *
 * <p><strong>Notes:</strong>
 * <ul>
 *   <li>This class is not intended for unit tests that need to inject custom {@code InputStream}s.
 *       Tests should capture/redirect {@code System.in} or use higher-level abstractions.</li>
...
public final class InputUtils {
     ...
     * <p>Behavior:
     * <ul>
     *   <li>Returns the trimmed line when available.</li>
     *   <li>Returns {@code null} if the input stream is closed or an error occurs while reading
     *       (e.g., {@link IllegalStateException} or {@link NoSuchElementException}).</li>
     * </ul>
     *
