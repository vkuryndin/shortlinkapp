 ...
 * <ul>
 *   <li>{@link #DATA_DIR} – root data folder.</li>
 *   <li>{@link #USERS_JSON} – users registry JSON.</li>
 *   <li>{@link #LINKS_JSON} – short links JSON.</li>
 *   <li>{@link #EVENTS_JSON} – event log JSON.</li>
 * </ul>
 *
