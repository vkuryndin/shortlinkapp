 ...
 *
 * <p>ID generation is based on a monotonically increasing in-memory sequence restored from
 * existing IDs (e.g. {@code L-000123}) on startup.
 */
public class LinksRepository {
    ...
    /**
     * Creates a repository instance and loads existing links from the disk. Also restores the internal
     * ID sequence from the maximum numeric suffix of IDs of the form {@code L-######}.
     */
     ...
     * repository. Otherwise, entries are left in place and their {@link Status} is set to
     * {@link Status#EXPIRED}. A flush occurs if anything changed.
     *
