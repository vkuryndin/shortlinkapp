...
/**
 * Minimal stub to centralize atomic JSON writes (we'll expand later).
 */
public final class StorageJson {
    ...
    public static <T> void writeAtomic(Path target, List<T> items, Class<T> clazz) throws IOException {
