...
public final class LocalUuid {
    ...
    public static String ensureCurrentUserUuid() {
        try {
            ...
            try (BufferedWriter bw = Files.newBufferedWriter(UUID_FILE, StandardCharsets.UTF_8,
            ...
            System.err.println("Warning: cannot persist user UUID, using ephemeral: " + fallback
                    + " (cause: " + e.getMessage() + ")");
            return fallback;
        }
    }
